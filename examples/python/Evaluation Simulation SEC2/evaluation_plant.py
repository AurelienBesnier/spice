...
if __name__ == "__main__":
    ids, photons = read_resultat_plant(
        "res_final/captor_result-1000000000-655-665-nm_plant.csv"
    )

    plt.plot(ids, photons, linestyle="--", marker="o", color="b")
    plt.title(
        "Wavelength 655-665 nm / Distribution des photons sur des organes du plant"
    )
